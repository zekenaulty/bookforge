...
class TimelineNodeRef:
    ...
    def __post_init__(self) -> None:
        ...
        if not is_valid_workflow_family(workflow_family):
        ...
        revision_id = _clean_required(self.revision_id, "revision_id")
    ...
    @classmethod
    def from_dict(cls, payload: Dict[str, Any]) -> "TimelineNodeRef":
        if not isinstance(payload, dict):
            raise ValueError("TimelineNodeRef payload must be a dictionary.")
        return cls(
