<!-- begin entry=E001 semantic=repair.phase_intro_timeline_and_state_primacy_rules source=resources/prompt_blocks/phase/repair/phase_intro_timeline_and_state_primacy_rules.md repeat=1/1 -->
# REPAIR
...
<!-- end entry=E001 semantic=repair.phase_intro_timeline_and_state_primacy_rules -->
<!-- begin entry=E002 semantic=repair.must_stay_true_reconciliation_rule source=resources/prompt_blocks/shared/summary/must_stay_true_reconciliation_rule.md repeat=1/1 -->
...
<!-- end entry=E002 semantic=repair.must_stay_true_reconciliation_rule -->
<!-- begin entry=E003 semantic=repair.must_stay_true_remove_directive_rule source=resources/prompt_blocks/shared/summary/must_stay_true_remove_directive_rule.md repeat=1/1 -->
...
<!-- end entry=E003 semantic=repair.must_stay_true_remove_directive_rule -->
<!-- begin entry=E004 semantic=repair.inventory_mechanics_ui_and_scope_rules source=resources/prompt_blocks/phase/repair/inventory_mechanics_ui_and_scope_rules.md repeat=1/1 -->
...
<!-- end entry=E004 semantic=repair.inventory_mechanics_ui_and_scope_rules -->
<!-- begin entry=E005 semantic=repair.non_real_timeline_scope_override_rule source=resources/prompt_blocks/shared/scope/non_real_timeline_scope_override_rule.md repeat=1/1 -->
...
<!-- end entry=E005 semantic=repair.non_real_timeline_scope_override_rule -->
<!-- begin entry=E006 semantic=repair.required_output_blocks_and_state_patch_core_rules source=resources/prompt_blocks/phase/repair/required_output_blocks_and_state_patch_core_rules.md repeat=1/1 -->
...
<!-- end entry=E006 semantic=repair.required_output_blocks_and_state_patch_core_rules -->
<!-- begin entry=E007 semantic=repair.global_continuity_updates_array_rule source=resources/prompt_blocks/shared/continuity/global_continuity_updates_array_rule.md repeat=1/1 -->
...
<!-- end entry=E007 semantic=repair.global_continuity_updates_array_rule -->
<!-- begin entry=E008 semantic=repair.json_shape_guardrails_core_arrays_and_summary source=resources/prompt_blocks/phase/repair/json_shape_guardrails_core_arrays_and_summary.md repeat=1/1 -->
...
<!-- end entry=E008 semantic=repair.json_shape_guardrails_core_arrays_and_summary -->
<!-- begin entry=E009 semantic=repair.appearance_updates_object_shape_rule source=resources/prompt_blocks/shared/appearance/appearance_updates_object_shape_rule.md repeat=1/1 -->
...
<!-- end entry=E009 semantic=repair.appearance_updates_object_shape_rule -->
<!-- begin entry=E010 semantic=repair.durable_registry_transfer_and_creation_requirements source=resources/prompt_blocks/phase/repair/durable_registry_transfer_and_creation_requirements.md repeat=1/1 -->
...
<!-- end entry=E010 semantic=repair.durable_registry_transfer_and_creation_requirements -->
<!-- begin entry=E011 semantic=repair.transfer_registry_conflict_rule source=resources/prompt_blocks/shared/registry/transfer_registry_conflict_rule.md repeat=1/1 -->
...
<!-- end entry=E011 semantic=repair.transfer_registry_conflict_rule -->
<!-- begin entry=E012 semantic=repair.durable_mutation_and_appearance_update_entry_rules source=resources/prompt_blocks/phase/repair/durable_mutation_and_appearance_update_entry_rules.md repeat=1/1 -->
...
<!-- end entry=E012 semantic=repair.durable_mutation_and_appearance_update_entry_rules -->
<!-- begin entry=E013 semantic=repair.appearance_updates_not_array_rule source=resources/prompt_blocks/shared/appearance/appearance_updates_not_array_rule.md repeat=1/1 -->
  - appearance_updates MUST be an object, not an array.
    - INVALID: "appearance_updates": [{"set": {...}, "reason": "..."}]
    - VALID: "appearance_updates": {"set": {"marks_add": [{"name": "Singed Hair", "location": "head", "durability": "durable"}]}, "reason": "..."}

<!-- end entry=E013 semantic=repair.appearance_updates_not_array_rule -->
<!-- begin entry=E014 semantic=repair.appearance_update_detail_inputs_and_json_contract_examples source=resources/prompt_blocks/phase/repair/appearance_update_detail_inputs_and_json_contract_examples.md repeat=1/1 -->
...
<!-- end entry=E014 semantic=repair.appearance_update_detail_inputs_and_json_contract_examples -->
<!-- begin entry=E015 semantic=repair.updates_arrays_only_contract_block source=resources/prompt_blocks/shared/json_contract/updates_arrays_only_contract_block.md repeat=1/1 -->
...
<!-- end entry=E015 semantic=repair.updates_arrays_only_contract_block -->
