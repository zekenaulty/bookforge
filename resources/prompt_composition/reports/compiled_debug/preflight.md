<!-- begin entry=E001 semantic=preflight.phase_intro_and_core_hard_rules source=resources/prompt_blocks/phase/preflight/phase_intro_and_core_hard_rules.md repeat=1/1 -->
# PREFLIGHT
...
<!-- end entry=E001 semantic=preflight.phase_intro_and_core_hard_rules -->
<!-- begin entry=E002 semantic=preflight.non_real_timeline_scope_override_rule source=resources/prompt_blocks/shared/scope/non_real_timeline_scope_override_rule.md repeat=1/1 -->
...
<!-- end entry=E002 semantic=preflight.non_real_timeline_scope_override_rule -->
<!-- begin entry=E003 semantic=preflight.transition_gate_world_alignment_and_constraint_enforcement source=resources/prompt_blocks/phase/preflight/transition_gate_world_alignment_and_constraint_enforcement.md repeat=1/1 -->
...
<!-- end entry=E003 semantic=preflight.transition_gate_world_alignment_and_constraint_enforcement -->
<!-- begin entry=E004 semantic=preflight.global_continuity_updates_array_rule source=resources/prompt_blocks/shared/continuity/global_continuity_updates_array_rule.md repeat=1/1 -->
...
<!-- end entry=E004 semantic=preflight.global_continuity_updates_array_rule -->
<!-- begin entry=E005 semantic=preflight.durable_update_contracts_and_reason_categories source=resources/prompt_blocks/phase/preflight/durable_update_contracts_and_reason_categories.md repeat=1/1 -->
...
<!-- end entry=E005 semantic=preflight.durable_update_contracts_and_reason_categories -->
<!-- begin entry=E006 semantic=preflight.updates_arrays_only_contract_block source=resources/prompt_blocks/shared/json_contract/updates_arrays_only_contract_block.md repeat=1/1 -->
...
<!-- end entry=E006 semantic=preflight.updates_arrays_only_contract_block -->
<!-- begin entry=E007 semantic=preflight.input_placeholders_and_output_shape_examples source=resources/prompt_blocks/phase/preflight/input_placeholders_and_output_shape_examples.md repeat=1/1 -->
...
<!-- end entry=E007 semantic=preflight.input_placeholders_and_output_shape_examples -->
