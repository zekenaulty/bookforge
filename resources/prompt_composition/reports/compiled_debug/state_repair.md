<!-- begin entry=E001 semantic=state_repair.phase_intro_goal_and_reconciliation_rules source=resources/prompt_blocks/phase/state_repair/phase_intro_goal_and_reconciliation_rules.md repeat=1/1 -->
# STATE REPAIR
...
<!-- end entry=E001 semantic=state_repair.phase_intro_goal_and_reconciliation_rules -->
<!-- begin entry=E002 semantic=state_repair.must_stay_true_remove_directive_rule source=resources/prompt_blocks/shared/summary/must_stay_true_remove_directive_rule.md repeat=1/1 -->
...
<!-- end entry=E002 semantic=state_repair.must_stay_true_remove_directive_rule -->
<!-- begin entry=E003 semantic=state_repair.core_state_patch_rules_and_mechanics_ownership source=resources/prompt_blocks/phase/state_repair/core_state_patch_rules_and_mechanics_ownership.md repeat=1/1 -->
...
<!-- end entry=E003 semantic=state_repair.core_state_patch_rules_and_mechanics_ownership -->
<!-- begin entry=E004 semantic=state_repair.global_continuity_updates_array_rule source=resources/prompt_blocks/shared/continuity/global_continuity_updates_array_rule.md repeat=1/1 -->
...
<!-- end entry=E004 semantic=state_repair.global_continuity_updates_array_rule -->
<!-- begin entry=E005 semantic=state_repair.json_shape_guardrails_and_registry_requirements source=resources/prompt_blocks/phase/state_repair/json_shape_guardrails_and_registry_requirements.md repeat=1/1 -->
...
<!-- end entry=E005 semantic=state_repair.json_shape_guardrails_and_registry_requirements -->
<!-- begin entry=E006 semantic=state_repair.transfer_registry_conflict_rule source=resources/prompt_blocks/shared/registry/transfer_registry_conflict_rule.md repeat=1/1 -->
...
<!-- end entry=E007 semantic=state_repair.durable_mutation_constraints_scope_and_reason_rules -->
<!-- begin entry=E008 semantic=state_repair.non_real_timeline_scope_override_rule source=resources/prompt_blocks/shared/scope/non_real_timeline_scope_override_rule.md repeat=1/1 -->
...
<!-- end entry=E008 semantic=state_repair.non_real_timeline_scope_override_rule -->
<!-- begin entry=E009 semantic=state_repair.input_placeholders_output_blocks_and_json_contract_examples source=resources/prompt_blocks/phase/state_repair/input_placeholders_output_blocks_and_json_contract_examples.md repeat=1/1 -->
Inputs
...
<!-- end entry=E009 semantic=state_repair.input_placeholders_output_blocks_and_json_contract_examples -->
<!-- begin entry=E010 semantic=state_repair.updates_arrays_only_contract_block source=resources/prompt_blocks/shared/json_contract/updates_arrays_only_contract_block.md repeat=1/1 -->
