...
- Plan Scope: `Drafts/bookforge-visual-asset-generation-skills`
- Compiled At (UTC): `2026-04-28T14:05:51Z`
...
14. `artifacts/legacy-image-system-audit.md`
15. `artifacts/provider-price-quality-report.md`
...
| --- | --- | --- | --- |
| 0010-audit-legacy-image-system-and-current-provider-options | draft | - | Capture old image-system lessons and current provider price/capability evidence. |
| 0020-define-visual-asset-contracts-and-provider-capabilities | draft | 0010 | Freeze visual asset, prompt plan, provider descriptor, reference image, layer manifest, and receipt contracts. |
| 0030-add-style-and-layer-prompt-planner | draft | 0020 | Add T1 visual prompt planning for backgrounds, characters, scene images, transparent layers, and compositions. |
| 0040-add-openai-image-provider-adapter | draft | 0020, 0030 | Implement the first real provider adapter, readiness, receipts, and refusal semantics for OpenAI GPT Image/DALL-E. |
| 0050-add-google-and-xai-provider-descriptors-and-adapters | draft | 0020, 0030 | Add Gemini/Nano Banana and xAI/Grok descriptors, then adapters only when configured and verified. |
| 0060-add-image-generation-actions-cli-and-readiness | draft | 0040 | Expose visual actions, readiness, and CLI surfaces for provider list, prompt plan, generate, refine, and compose. |
...
| 0080-add-nanda-skill-projection-and-fixtures | draft | 0060, 0070 | Publish visual skills through capability projection with Nanda fixtures and theater-safe statuses. |
...
## Source 14: `artifacts/legacy-image-system-audit.md`
...
## Source 15: `artifacts/provider-price-quality-report.md`
