...
- Prompt budgeter enforces per-step budgets and deterministic truncation rules.
...
- Truncation priority order is fixed and never truncates JSON mid-object.
- Optional sections drop first (last excerpt, low-priority canon) before core constraints.
...
Tasks
- Define per-step budgets and truncation priority rules.
...
- Add tests for deterministic budgeting and truncation behavior.
Definition of Done
- Budgeter enforces budgets and continuity pack replaces raw prose excerpts.
...
- [ ] Story 2: LLM provider layer
- [ ] Story 3.R: Schema governance and validation refinement
- [ ] Story 3: Schema versioning and validation implementation
- [ ] Story 4.R: Prompt system and caching refinement
- [ ] Story 4: Prompt templates and registry implementation
- [ ] Story 5.R: Prompt budgeter and continuity pack refinement
- [ ] Story 5: Budgeter and continuity pack implementation
- [ ] Story 6.R: Author library versioning refinement
- [ ] Story 6: Author creation pipeline
- [ ] Story 7.R: Workspace init and book schema refinement
- [ ] Story 7: Workspace init command
- [ ] Story 8.R: Outline and scene card schema refinement
- [ ] Story 8: Outline generation and scene planning
- [ ] Story 9.R: Writing loop and state patch refinement
- [ ] Story 9: Writing loop implementation
- [ ] Story 10.R: Pre-generation duplication prevention refinement
- [ ] Story 10: Opening preview and banned phrases
- [ ] Story 11.R: Lint, repair, and similarity checks refinement
- [ ] Story 11: Lint, repair, and similarity gates
- [ ] Story 12.R: Canon store and retrieval refinement
- [ ] Story 12: Canon store and retrieval
- [ ] Story 13.R: Compile and export refinement
- [ ] Story 13: Compile and export implementation
- [ ] Story 14.R: CLI orchestration and rerun controls refinement
- [ ] Story 14: CLI commands and rerun controls
- [ ] Story 15.R: Observability and prompt hashing refinement
- [ ] Story 15: Logging and metrics
- [ ] Story 16.R: Tests and documentation refinement
- [ ] Story 16: Tests and documentation
