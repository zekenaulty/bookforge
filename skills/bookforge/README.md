...
## Run
- `bookforge.run.scene-planning` -> `skills/bookforge/run/scene-planning` (run.plan / plan)
...
- `bookforge.run.scene-writing` -> `skills/bookforge/run/scene-writing` (run.write / write)
- `bookforge.run.scene-repair` -> `skills/bookforge/run/scene-repair` (run.repair / repair)
- `bookforge.run.state-repair` -> `skills/bookforge/run/state-repair` (run.state_repair / state_repair)
- `bookforge.run.scene-lint` -> `skills/bookforge/run/scene-lint` (run.lint / lint)
- `bookforge.run.scene-commit` -> `skills/bookforge/run/scene-commit` (run.commit / commit)
